...
| --- | --- | --- | --- | --- |
| 00:00–00:03.50 | S01 — The outside story | Black resolves into `../assets/keyframe-01-world.png`; 4% dolly-in, calm teal flow. | Full page: **`I ASKED AI TO ATTACK MATH I BARELY UNDERSTAND.`** Footer: `HUMAN-DIRECTED • AI-EXECUTED` and `EVIDENCE, NOT TRUST`. | Establish the unusual experiment and the requirement for checkable output. |
