...
output_file="${2:-${guide_dir}/renders/edit/navier-stokes-flow-post-v03-review-720p.mp4}"
...
# V03 keeps the native review resolution and V02's two-frame source removal.
# The persistent geometry change at 15.000 s needs a six-output-frame bridge;
# the already accepted 23 s repair remains a two-frame bridge. Audio contains
# no de-click or other restoration filter and follows the same local timing.
...
[va][vb]xfade=transition=fade:duration=0.200000:offset=14.800000[vab];\
[v2]trim=start=23.083333:end=30.150000,setpts=PTS-STARTPTS[vc];\
[vab][vc]xfade=transition=fade:duration=0.083333:offset=22.633334,\
...
[pre][p2]acrossfade=d=0.200000:c1=qsin:c2=qsin[mid];\
[a3]atrim=start=23.083333:end=30.150000,asetpts=PTS-STARTPTS[p3];\
