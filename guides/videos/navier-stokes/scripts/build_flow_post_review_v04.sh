...
output_file="${2:-${guide_dir}/renders/edit/navier-stokes-flow-post-v04-review-720p.mp4}"
...
# Frame matching shows that frame 359 (14.958 s) recurs at frame 383
# (15.958 s), and frame 551 (22.958 s) recurs at frame 575 (23.958 s).
# Remove those two actual overlap loops instead of dissolving between different
# geometries. Retiming each remaining 169-frame continuation to eight seconds
# preserves the locked overlay timeline and yields a continuous camera path.
