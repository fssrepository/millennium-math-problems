...
> `../../01_story/FALSIFICATION_VISUAL.md` and approve no new generation until the v02
> preview is accepted.
...
## S02 — 6 s — start frame: `../../assets/keyframe-01-world.png`
...
## S03 — 5 s — start frame: `../../assets/keyframe-03-checkpoint.png`
...
Orbit thirty degrees around the coral bend with an 85mm macro lens. The broad
teal vortex stretches the coral core while the finest nearby cyan ripples softly
fade, a restrained contrast between stretching and viscous smoothing. Finish
with a brief camera arrest. Keep calm negative space for three method-family
cards added later. Do not depict people or portraits. Ambient audio only.

No generated text, names, letters, equations, subtitles, logos, watermark, UI,
people, portraits, ocean waves, smoke, fire, lightning, creature, extra coral
filament, broken glass, explosion, checkmark, camera shake, flicker, material
morphing, palette drift, speech or singing.
```

## S04 — 8 s — start frame: `../../assets/keyframe-01-world.png`
...
then perform the sequence's fastest smooth 35mm flight through them. Four tiny
amber pulses appear at distinct shell crossings like computational tests. The
original cube and coral filament remain the anchor. Controlled acceleration,
no random shake and no cuts. Provide clean start and end handles for
editor-timed T+ labels. Ambient electronic pulses only, no voice.
...
victory symbolism, fantasy, random cuts, camera shake, flicker, morphing,
color drift, dialogue or singing.
```

## S05 — 8 s — start frame: `../../assets/keyframe-03-checkpoint.png`
...
the same coral bend. Teal flow moves continuously around it. One thin
translucent amber scan plane crosses the bend once, creates a brief precise
highlight, then clears. Supply generous clean motion before and after the scan
for editor-created exact-gradient, K1-to-K8, rejection, checkpoint and restart
beats. Camera energy is distinctly lower than S04. Subtle scan tone only.
...
the S07 copy from `../../04_editorial/EDITOR_OVERLAYS_EN.md`.
