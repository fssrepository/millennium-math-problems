...
10. Complete the S02 row in `../../02_production/REVIEW_SHEET.csv`.
11. If it passes, stop generating S02 and move to S05.
12. If it fails, choose one repair from `../../02_production/PRODUCTION_WORKFLOW.md`, change only
...
`../../02_production/REVIEW_SHEET.csv`, revise one specific prompt instruction and generate a
