...
struct LocalSldProjectiveQuarticCrossReport {
    ...
    SpectralReal cross_outer_commutator = 0.0L;
    SpectralReal cross_advecting_nested = 0.0L;
    SpectralReal cross_enstrophy_normalization = 0.0L;
    SpectralReal cross_palinstrophy_normalization = 0.0L;
    ...
    SpectralReal cross_outer_commutator_power_one = 0.0L;
    SpectralReal cross_advecting_nested_power_one = 0.0L;
    SpectralReal cross_enstrophy_normalization_power_one = 0.0L;
    SpectralReal cross_palinstrophy_normalization_power_one = 0.0L;
