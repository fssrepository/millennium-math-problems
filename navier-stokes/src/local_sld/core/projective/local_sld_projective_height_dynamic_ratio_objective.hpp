...
struct LocalSldProjectiveHeightDynamicRatioObjectiveValue {
    std::size_t height_shell_count = 0;
    SpectralReal dynamic_paired_bracket_envelope = 0.0L;
...
class LocalSldProjectiveHeightDynamicRatioObjective {
public:
    ...
    [[nodiscard]] LocalSldProjectiveHeightDynamicRatioObjectiveValue
